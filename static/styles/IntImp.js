...
function initMomentum() {
  ...
  // Функция для адаптивной ширины канваса
  function setCanvasSize() {
    var containerWidth = container.clientWidth;
    var newWidth = containerWidth - 40;
  ...
  if (!momentumState.collided) {
    ...
    if (distance <= minDistance) {
      ...
      if (type === "inelastic") {
        ...
        var v1f =
          ((ball1.m - ball2.m) * ball1.v + 2 * ball2.m * ball2.v) /
          (ball1.m + ball2.m);
        var v2f =
          ((ball2.m - ball1.m) * ball2.v + 2 * ball1.m * ball1.v) /
          (ball1.m + ball2.m);
        ball1.v = v1f;
        ball2.v = v2f;
      }
